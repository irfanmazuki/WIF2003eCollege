...
<head>
            ...
            <div class="collapse navbar-collapse" id="navbarsExample09">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link  dropdown-toggle active" href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Activity<span class="sr-only">(current)</span></a>
                        <div class="dropdown-menu" aria-labelledby="dropdown01">
                            <a class="dropdown-item" href="Activity-list.php">Apply New Activity</a>
                            <a class="dropdown-item" href="Activity-history.php">Activity History</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
    ...
    <title>e-College: Activity</title>
</head>